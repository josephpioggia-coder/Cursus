        ...
        enfants: [
          {
            ...
            enfants: [
              { code: "N3.02.04.01.01", nom: "livre dont vous êtes le héros", statut: "partiel", aide: "Auditer structure et cohérence ; module graphe interactif à développer si projet complexe." },
              { code: "N3.02.04.01.02", nom: "récit à embranchements", statut: "partiel", aide: "Auditer structure et cohérence ; module graphe interactif à développer si projet complexe." },
              { code: "N3.02.04.01.03", nom: "jeu narratif textuel", statut: "partiel", aide: "Auditer structure et cohérence ; module graphe interactif à développer si projet complexe." },
              { code: "N3.02.04.01.04", nom: "visual novel", statut: "partiel", aide: "Auditer structure et cohérence ; module graphe interactif à développer si projet complexe." },
              { code: "N3.02.04.01.05", nom: "escape book", statut: "partiel", aide: "Auditer structure et cohérence ; module graphe interactif à développer si projet complexe." },
            ],
          },
        ],
      },
        ...
        enfants: [
          {
            ...
            enfants: [
              { code: "N3.06.01.01.01", nom: "oracle méditatif", statut: "partiel", aide: "Clarifier usage, non-divinatoire si nécessaire, sécurité et livret." },
              { code: "N3.06.01.01.02", nom: "oracle spirituel non divinatoire", statut: "partiel", aide: "Clarifier usage, non-divinatoire si nécessaire, sécurité et livret." },
              { code: "N3.06.01.01.03", nom: "cartes bibliques", statut: "partiel", aide: "Clarifier usage, non-divinatoire si nécessaire, sécurité et livret." },
              { code: "N3.06.01.01.04", nom: "cartes thérapeutiques à cadrer", statut: "partiel", aide: "Clarifier usage, non-divinatoire si nécessaire, sécurité et livret." },
              { code: "N3.06.01.01.05", nom: "cartes de coaching", statut: "partiel", aide: "Clarifier usage, non-divinatoire si nécessaire, sécurité et livret." },
              { code: "N3.06.01.01.06", nom: "cartes pédagogiques", statut: "partiel", aide: "Clarifier usage, non-divinatoire si nécessaire, sécurité et livret." },
            ],
          },
          {
            code: "N3.06.01.02",
      ...
      },
      {
        ...
        enfants: [
          ...
          },
          {
            ...
            enfants: [
              { code: "N3.07.03.03.01", nom: "LinkedIn", statut: "partiel", aide: "Audit du message et du ton ; algorithmes/résultats non garantis." },
              { code: "N3.07.03.03.02", nom: "Facebook", statut: "partiel", aide: "Audit du message et du ton ; algorithmes/résultats non garantis." },
              { code: "N3.07.03.03.03", nom: "Instagram", statut: "partiel", aide: "Audit du message et du ton ; algorithmes/résultats non garantis." },
              { code: "N3.07.03.03.04", nom: "X / Threads", statut: "partiel", aide: "Audit du message et du ton ; algorithmes/résultats non garantis." },
              { code: "N3.07.03.03.05", nom: "publication longue", statut: "partiel", aide: "Audit du message et du ton ; algorithmes/résultats non garantis." },
              { code: "N3.07.03.03.06", nom: "carrousel texte", statut: "partiel", aide: "Audit du message et du ton ; algorithmes/résultats non garantis." },
            ],
          },
        ],
      },
